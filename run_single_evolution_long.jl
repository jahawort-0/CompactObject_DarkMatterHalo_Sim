...
circ_orbit = Integrate.initial_circular_orbit(M_DM, M_NS1, M_NS2, realpoly);  #Solve for Roche seperation, ciruclar orbit   circ_orbit = [a_RL, M_DM, M_NS1, M_NS2, R_DM, J, 0.]
...
println("Dark matter outflow beginning at r = ", circ_orbit[1], " km")
