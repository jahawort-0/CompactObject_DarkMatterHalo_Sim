...
circ_orbit=Integrate.initial_circular_orbit(M_DM, M_NS1, M_NS2, realpoly);  #Solve for Roche sepeartion, ciruclar orbit
...
p1 = plot(df_waveform.t,df_waveform.f,xlabel = "time [s]", ylabel = "frequency [Hz]", dpi = 200, ylim = (0,60),label = "simulated")
